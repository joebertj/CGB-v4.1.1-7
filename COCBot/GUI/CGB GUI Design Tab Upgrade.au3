...
Local $x = 30, $y = 150
	...
	Local $x = 30, $y = 220
		...
		$chkUpgradeKing = GUICtrlCreateCheckbox("Upgrade King", $x + 60, $y-10, -1, -1)
			$txtTip = "Check box to enable continuously upgrade King when you have enough DE"
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "ichkUpgradeKing")		
		$chkUpgradeQueen = GUICtrlCreateCheckbox("Upgrade Queen", $x + 225, $y-10, -1, -1)
			$txtTip = "Check box to enable continuously upgrade Queen when you have enough DE"
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "ichkUpgradeQueen")			
		GUICtrlCreateGroup("", -99, -99, 1, 1)	
		GUICtrlCreateIcon($pIconLib, $eIcnKing, $x + 30, $y-10, 21, 21)
		GUICtrlCreateIcon($pIconLib, $eIcnQueen, $x + 195, $y-10, 21, 21)
